...
public class FoundAdapter extends RecyclerView.Adapter <FoundAdapter.ImageViewHolder> {
    ...
    private final List<FoundClass> mUploads;

    private LostAdapter.OnitemClickListener mListener;


    public FoundAdapter(Context context,List<FoundClass> uploads){
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        FoundClass uploadCurrent = mUploads.get(position);
...
//        we can use centre inside
    ...
    public  void  setOnItemClickListener(LostAdapter.OnitemClickListener listener){
